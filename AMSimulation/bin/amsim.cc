...
int main(int argc, char **argv) {
    ...
    config.add_options()
        ...
        ("htRZCotanThetaBins"    , po::value<unsigned   >(&option.htRZCotanThetaBins    )->default_value(    32 ), "Specify the minimum value of cotan(theta) at the edge of the HT matrix")
        ...
        ("htRZZ0Min"             , po::value<float      >(&option.htRZZ0Min             )->default_value( -15.0 ), "Specify the minimum value of zT at the edge of the HT matrix")
        ("htRZZ0Max"             , po::value<float      >(&option.htRZZ0Max             )->default_value(  15.0 ), "Specify the maximum value of zT at the edge of the HT matrix")
